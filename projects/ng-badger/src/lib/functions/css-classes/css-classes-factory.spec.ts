...
export class TestComponent implements OnInit {
  @ViewChild('test', {static: true, read: ElementRef})
  child!: ElementRef;
  test!: CssClasses;

  private cssFactory = cssClassesFactory();

  ngOnInit() {
    this.test = this.cssFactory(this.child)(['initial']);
  }
}

describe('cssClassesFactory()', () => {
  ...
  beforeEach(() => {
    ...
    nativeElement = component.componentInstance.child.nativeElement;
  })
